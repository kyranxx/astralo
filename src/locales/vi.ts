...
const vi: Translations = {
    meta: { title: 'Astralo - Tử Vi Chuyên Nghiệp', description: 'Nhận tử vi cá nhân. Dự đoán chính xác cho cung hoàng đạo của bạn.', keywords: 'tử vi, chiêm tinh, cung hoàng đạo, tử vi cá nhân' },
    header: { badge: 'Tử Vi Cá Nhân', online: 'Trực tuyến' },
