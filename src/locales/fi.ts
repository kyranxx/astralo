...
const fi: Translations = {
    meta: { title: 'Astralo - Ammattimaiset Horoskooppit', description: 'Hanki henkilökohtainen horoskooppisi. Tarkat ennusteet horoskooppimerkillesi.', keywords: 'horoskooppi, astrologia, horoskooppimerkki, henkilökohtainen horoskooppi' },
    header: { badge: 'Henkilökohtainen Horoskooppi', online: 'Online' },
