...
const el: Translations = {
    meta: { title: 'Astralo - Επαγγελματικά Ωροσκόπια', description: 'Αποκτήστε εξατομικευμένο ωροσκόπιο. Ακριβείς προβλέψεις για το ζώδιό σας.', keywords: 'ωροσκόπιο, αστρολογία, ζώδιο, εξατομικευμένο ωροσκόπιο' },
    header: { badge: 'Εξατομικευμένα Ωροσκόπια', online: 'Online' },
