...
const ja: Translations = {
    ...
    form: { title: '星占いを入手', description: 'Fill in your details.', name: '氏名', email: 'メール', birthDate: '生年月日', birthTime: '時間（任意）', birthPlace: '出生地', partnerName: 'パートナー名', partnerBirthDate: 'パートナー生年月日', partnerBirthTime: 'パートナー時間', partnerBirthPlace: 'パートナー出生地', submit: '支払いに進む', processing: '処理中...' },
