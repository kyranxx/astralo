...
const ko: Translations = {
    ...
    form: { title: '운세 받기', description: 'Fill in your details.', name: '성명', email: '이메일', birthDate: '생년월일', birthTime: '시간 (선택)', birthPlace: '출생지', partnerName: '파트너 이름', partnerBirthDate: '파트너 생년월일', partnerBirthTime: '파트너 시간', partnerBirthPlace: '파트너 출생지', submit: '결제 진행', processing: '처리 중...' },
