...
const uk: Translations = {
    meta: { title: 'Astralo - Професійні Гороскопи', description: 'Отримайте персоналізований гороскоп. Точні прогнози для вашого знаку зодіаку.', keywords: 'гороскоп, астрологія, зодіак, персоналізований гороскоп' },
    header: { badge: 'Персоналізовані Гороскопи', online: 'Онлайн' },
