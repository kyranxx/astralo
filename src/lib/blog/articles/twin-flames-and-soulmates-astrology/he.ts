/**
 * twin-flames-and-soulmates-astrology - HE
 */
...
export const he: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of אהבה: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of אהבה: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 מזלs</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When אהבה Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of אהבה</h2>
