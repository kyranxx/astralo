/**
 * twin-flames-and-soulmates-astrology - KO
 */
...
export const ko: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of 사랑: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of 사랑: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 별자리s</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When 사랑 Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of 사랑</h2>
