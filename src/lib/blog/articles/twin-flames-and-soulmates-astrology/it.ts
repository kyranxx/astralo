/**
 * twin-flames-and-soulmates-astrology - IT
 */
...
export const it: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Amore: Sole, Luna, and Ascendant</h2>
      ...
      <h2 id="the-glue">The Long Haul: Saturn, Jupiter & The Outer Pianetas</h2>
      ...
      <h2 id="asteroids">Asteroids of Amore: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="house-overlays">Casa Overlays: Where We Live in Each Other's Lives</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Segnos</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Amore Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Amore</h2>
