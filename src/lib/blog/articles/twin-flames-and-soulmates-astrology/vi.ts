/**
 * twin-flames-and-soulmates-astrology - VI
 */
...
export const vi: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Tình yêu: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of Tình yêu: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Cungs</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Tình yêu Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Tình yêu</h2>
