/**
 * twin-flames-and-soulmates-astrology - FR
 */
import type { BlogPostTranslation } from '../../types';

export const fr: BlogPostTranslation = {
    title: "🔥 Twin Flames, Soulmates, and Karma: The Astrology of Deep Connections",
    excerpt: "Is it love, or is it fate? Explore the mystical world of relationship astrology. Learn how to identify Twin Flames, Soulmates, and Karmic lessons in your birth chart.", // Excerpt remains EN mostly
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Amour: Soleil, Lune, and Ascendant</h2>
      ...
      <h2 id="the-glue">The Long Haul: Saturn, Jupiter & The Outer Planètes</h2>
      ...
      <h2 id="asteroids">Asteroids of Amour: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="house-overlays">Maison Overlays: Where We Live in Each Other's Lives</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Signes</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Amour Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Amour</h2>
