/**
 * twin-flames-and-soulmates-astrology - TR
 */
...
export const tr: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Aşk: Güneş, Ay, and Ascendant</h2>
      ...
      <h2 id="the-glue">The Long Haul: Saturn, Jupiter & The Outer Gezegens</h2>
      ...
      <h2 id="asteroids">Asteroids of Aşk: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="house-overlays">Ev Overlays: Where We Live in Each Other's Lives</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Burçs</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Aşk Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Aşk</h2>
