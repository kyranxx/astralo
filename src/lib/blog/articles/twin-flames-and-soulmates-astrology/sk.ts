/**
 * twin-flames-and-soulmates-astrology - SK
 */
...
export const sk: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Láska: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of Láska: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Znamenies</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Láska Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Láska</h2>
