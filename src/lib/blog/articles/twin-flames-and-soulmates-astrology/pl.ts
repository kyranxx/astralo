/**
 * twin-flames-and-soulmates-astrology - PL
 */
...
export const pl: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Miłość: Słońce, Księżyc, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of Miłość: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="house-overlays">Dom Overlays: Where We Live in Each Other's Lives</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Znaks</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Miłość Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Miłość</h2>
