/**
 * twin-flames-and-soulmates-astrology - DE
 */
...
export const de: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Liebe: Sonne, Mond, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of Liebe: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="house-overlays">Haus Overlays: Where We Live in Each Other's Lives</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Zeichens</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Liebe Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Liebe</h2>
