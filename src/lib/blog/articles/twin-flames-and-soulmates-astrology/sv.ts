/**
 * twin-flames-and-soulmates-astrology - SV
 */
...
export const sv: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Kärlek: Sol, Måne, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of Kärlek: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="house-overlays">Hus Overlays: Where We Live in Each Other's Lives</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Teckens</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Kärlek Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Kärlek</h2>
