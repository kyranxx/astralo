/**
 * twin-flames-and-soulmates-astrology - ZH
 */
...
export const zh: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of 爱情: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of 爱情: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 标志s</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When 爱情 Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of 爱情</h2>
