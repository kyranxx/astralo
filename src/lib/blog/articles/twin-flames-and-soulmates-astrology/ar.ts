/**
 * twin-flames-and-soulmates-astrology - AR
 */
...
export const ar: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of الحب: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of الحب: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 برجs</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When الحب Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of الحب</h2>
