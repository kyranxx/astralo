/**
 * twin-flames-and-soulmates-astrology - TH
 */
...
export const th: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of ความรัก: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of ความรัก: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 สัญลักษณ์s</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When ความรัก Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of ความรัก</h2>
