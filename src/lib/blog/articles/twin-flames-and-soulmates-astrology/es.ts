/**
 * twin-flames-and-soulmates-astrology - ES
 */
...
export const es: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Amor: Sol, Luna, and Ascendant</h2>
      ...
      <h2 id="the-glue">The Long Haul: Saturn, Jupiter & The Outer Planetas</h2>
      ...
      <h2 id="asteroids">Asteroids of Amor: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Signos</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Amor Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Amor</h2>
