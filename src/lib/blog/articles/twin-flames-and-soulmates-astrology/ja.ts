/**
 * twin-flames-and-soulmates-astrology - JA
 */
...
export const ja: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of 愛: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of 愛: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 星座s</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When 愛 Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of 愛</h2>
