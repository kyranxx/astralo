/**
 * twin-flames-and-soulmates-astrology - ID
 */
...
export const id: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Cinta: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of Cinta: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Tandas</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Cinta Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Cinta</h2>
