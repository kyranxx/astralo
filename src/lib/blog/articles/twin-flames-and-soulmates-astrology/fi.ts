/**
 * twin-flames-and-soulmates-astrology - FI
 */
...
export const fi: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Rakkaus: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of Rakkaus: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Merkkis</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Rakkaus Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Rakkaus</h2>
