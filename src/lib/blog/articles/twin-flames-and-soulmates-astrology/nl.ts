/**
 * twin-flames-and-soulmates-astrology - NL
 */
...
export const nl: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Liefde: Zon, Maan, and Ascendant</h2>
      ...
      <h2 id="the-glue">The Long Haul: Saturn, Jupiter & The Outer Planeets</h2>
      ...
      <h2 id="asteroids">Asteroids of Liefde: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="house-overlays">Huis Overlays: Where We Live in Each Other's Lives</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Sterrenbeelds</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Liefde Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Liefde</h2>
