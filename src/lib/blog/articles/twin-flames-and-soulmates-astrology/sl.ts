/**
 * twin-flames-and-soulmates-astrology - SL
 */
...
export const sl: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Ljubezen: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of Ljubezen: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Znamenjes</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Ljubezen Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Ljubezen</h2>
