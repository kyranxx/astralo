/**
 * twin-flames-and-soulmates-astrology - HU
 */
...
export const hu: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Szerelem: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of Szerelem: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Jegys</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Szerelem Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Szerelem</h2>
