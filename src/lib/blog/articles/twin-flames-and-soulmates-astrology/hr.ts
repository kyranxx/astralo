...
export const hr: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Ljubav: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of Ljubav: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Ljubav Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Ljubav</h2>
