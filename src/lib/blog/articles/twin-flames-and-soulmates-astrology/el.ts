/**
 * twin-flames-and-soulmates-astrology - EL
 */
...
export const el: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="personal-planets">The Big Three of Αγάπη: Sun, Moon, and Ascendant</h2>
      ...
      <h2 id="asteroids">Asteroids of Αγάπη: Juno, Eros, and Psyche</h2>
      ...
      <h2 id="twin-flames-signs">Twin Flame Dynamics Through the 12 Σήμαs</h2>
      ...
      <h2 id="red-flags">Astrological Red Flags: When Αγάπη Becomes Toxic</h2>
      ...
      <h2 id="conclusion">The True Meaning of Αγάπη</h2>
