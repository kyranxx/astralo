/**
 * zodiac-compatibility-complete-guide - ES
 */
...
export const es: BlogPostTranslation = {
    ...
    content: `
      ...
      <h3>🔥 Fuego Signos (Aries, Leo, Sagitario)</h3>
      ...
      <h3>🌍 Tierra Signos (Tauro, Virgo, Capricornio)</h3>
      ...
      <h3>💨 Aire Signos (Géminis, Libra, Acuario)</h3>
      ...
      <h3>💧 Agua Signos (Cáncer, Escorpio, Piscis)</h3>
      ...
      <h2 id="love-planets">The Real Amor Planetas: Venus, Mars & The Luna</h2>
      ...
      <h2 id="best-matches-deep-dive">Deep Dive: Famous Zodíaco PAireings</h2>
      ...
      <h3>The "Empire Builders": Tauro & Capricornio</h3>
      ...
      <h3>The "Peter Pan" Duo: Géminis & Sagitario</h3>
      ...
      <h3>The "Psychic Link": Cáncer & Escorpio</h3>
