/**
 * zodiac-compatibility-complete-guide - AR
 */
import type { BlogPostTranslation } from '../../types';

export const ar: BlogPostTranslation = {
    title: "❤️ الأبراج برج Compatibility: The Definitive Guide to Cosmic الحب",
    ...
    content: `
      <h2 id="beyond-sun-signs">Why Sun برجs Aren't Everything</h2>
      ...
      <h2 id="elemental-love">The 4 Elements in الحب</h2>
      ...
      <h3>🔥 نار برجs (Aries, Leo, Sagittarius)</h3>
      ...
      <h3>🌍 ارض برجs (Taurus, Virgo, Capricorn)</h3>
      ...
      <h3>💨 هواء برجs (Gemini, Libra, Aquarius)</h3>
      ...
      <h3>💧 ماء برجs (Cancer, Scorpio, Pisces)</h3>
      ...
      <h2 id="love-planets">The Real الحب Planets: Venus, Mars & The Moon</h2>
      ...
      <h2 id="best-matches-deep-dive">Deep Dive: Famous الأبراج Pهواءings</h2>
