/**
 * zodiac-compatibility-complete-guide - TR
 */
import type { BlogPostTranslation } from '../../types';

export const tr: BlogPostTranslation = {
    title: "❤️ Zodyak Burç Compatibility: The Definitive Guide to Cosmic Aşk",
    ...
    content: `
      <h2 id="beyond-sun-signs">Why Güneş Burçs Aren't Everything</h2>
      ...
      <h2 id="elemental-love">The 4 Elements in Aşk</h2>
      ...
      <h3>🔥 Ateş Burçs (Koç, Aslan, Yay)</h3>
      ...
      <h3>🌍 Toprak Burçs (Boğa, Başak, Oğlak)</h3>
      ...
      <h3>💨 Hava Burçs (İkizler, Terazi, Kova)</h3>
      ...
      <h3>💧 Su Burçs (Yengeç, Akrep, Balık)</h3>
      ...
      <h2 id="love-planets">The Real Aşk Gezegens: Venus, Mars & The Ay</h2>
      ...
      <h3>1. The Ay 🌙 (Emotional Safety)</h3>
      ...
      <h3>2. Venus ♀ (Romantizm & Values)</h3>
      ...
      <h2 id="best-matches-deep-dive">Deep Dive: Famous Zodyak PHavaings</h2>
      
      <h3>The "Power Couple": Koç & Terazi</h3>
      ...
      <h3>The "Empire Builders": Boğa & Oğlak</h3>
      ...
      <h3>The "Peter Pan" Duo: İkizler & Yay</h3>
      ...
      <h3>The "Psychic Link": Yengeç & Akrep</h3>
