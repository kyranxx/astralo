/**
 * zodiac-compatibility-complete-guide - NL
 */
import type { BlogPostTranslation } from '../../types';

export const nl: BlogPostTranslation = {
    title: "❤️ Dierenriem Sterrenbeeld Compatibility: The Definitive Guide to Cosmic Liefde",
    ...
    content: `
      <h2 id="beyond-sun-signs">Why Zon Sterrenbeelds Aren't Everything</h2>
      ...
      <h2 id="elemental-love">The 4 Elements in Liefde</h2>
      ...
      <h3>🔥 Vuur Sterrenbeelds (Ram, Leeuw, Boogschutter)</h3>
      ...
      <h3>🌍 Aarde Sterrenbeelds (Stier, Maagd, Steenbok)</h3>
      ...
      <h3>💨 Lucht Sterrenbeelds (Tweelingen, Weegschaal, Waterman)</h3>
      ...
      <h3>💧 Water Sterrenbeelds (Kreeft, Schorpioen, Vissen)</h3>
      ...
      <h2 id="love-planets">The Real Liefde Planeets: Venus, Mars & The Maan</h2>
      ...
      <h3>1. The Maan 🌙 (Emotional Safety)</h3>
      ...
      <h3>2. Venus ♀ (Romantiek & Values)</h3>
      ...
      <h2 id="best-matches-deep-dive">Deep Dive: Famous Dierenriem PLuchtings</h2>
      
      <h3>The "Power Couple": Ram & Weegschaal</h3>
      ...
      <h3>The "Empire Builders": Stier & Steenbok</h3>
      ...
      <h3>The "Peter Pan" Duo: Tweelingen & Boogschutter</h3>
      ...
      <h3>The "Psychic Link": Kreeft & Schorpioen</h3>
