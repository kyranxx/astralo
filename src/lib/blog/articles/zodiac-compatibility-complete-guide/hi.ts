/**
 * zodiac-compatibility-complete-guide - HI
 */
import type { BlogPostTranslation } from '../../types';

export const hi: BlogPostTranslation = {
    title: "❤️ राशि चक्र राशि Compatibility: The Definitive Guide to Cosmic प्रेम",
    ...
    content: `
      <h2 id="beyond-sun-signs">Why Sun राशिs Aren't Everything</h2>
      ...
      <h2 id="elemental-love">The 4 Elements in प्रेम</h2>
      ...
      <h3>🔥 अग्नि राशिs (Aries, Leo, Sagittarius)</h3>
      ...
      <h3>🌍 पृथ्वी राशिs (Taurus, Virgo, Capricorn)</h3>
      ...
      <h3>💨 वायु राशिs (Gemini, Libra, Aquarius)</h3>
      ...
      <h3>💧 जल राशिs (Cancer, Scorpio, Pisces)</h3>
      ...
      <h2 id="love-planets">The Real प्रेम Planets: Venus, Mars & The Moon</h2>
      ...
      <h2 id="best-matches-deep-dive">Deep Dive: Famous राशि चक्र Pवायुings</h2>
