...
export const bn: BlogPostTranslation = {
    title: "❤️ রাশিচক্র চিহ্ন Compatibility: The Definitive Guide to Cosmic প্রেম",
    ...
    content: `
      <h2 id="beyond-sun-signs">Why Sun চিহ্নs Aren't Everything</h2>
      ...
      <h2 id="elemental-love">The 4 Elements in প্রেম</h2>
      ...
      <h3>🔥 আগুন চিহ্নs (Aries, Leo, Sagittarius)</h3>
      ...
      <h3>🌍 পৃথিবী চিহ্নs (Taurus, Virgo, Capricorn)</h3>
      ...
      <h3>💨 বায়ু চিহ্নs (Gemini, Libra, Aquarius)</h3>
      ...
      <h3>💧 জল চিহ্নs (Cancer, Scorpio, Pisces)</h3>
      ...
      <h2 id="love-planets">The Real প্রেম Planets: Venus, Mars & The Moon</h2>
      ...
      <h2 id="best-matches-deep-dive">Deep Dive: Famous রাশিচক্র Pবায়ুings</h2>
