...
export const en: BlogPostTranslation = {
    ...
    quickSummary: [
        ...
        'The "Incompatible" signs often provide the greatest opportunities for soul growth',
        'Venus determines affection style, while Mars drives passion and conflict style'
    ],
    keyTakeaways: [
        'Look for trines (same element) for ease, and oppositions for intense attraction',
        'Moon sign compatibility is crucial for living together and emotional safety',
        'Mercury compatibility dictates how well you solve problems together',
        'There is no "perfect" match; every pairing has strengths and challenges'
    ],
    tableOfContents: [
        ...
        { id: 'best-matches-deep-dive', title: 'Deep Dive: Best Matches' },
        { id: 'synastry', title: 'Advanced Tip: Synastry' }
    ],
    content: `
