/**
 * zodiac-compatibility-complete-guide - HR
 */
import type { BlogPostTranslation } from '../../types';

export const hr: BlogPostTranslation = {
    title: "❤️ Zodijak Znak Compatibility: The Definitive Guide to Cosmic Ljubav",
    ...
    content: `
      <h2 id="beyond-sun-signs">Why Sun Znaks Aren't Everything</h2>
      ...
      <h2 id="elemental-love">The 4 Elements in Ljubav</h2>
      ...
      <h3>🔥 Vatra Znaks (Aries, Leo, Sagittarius)</h3>
      ...
      <h3>🌍 Zemlja Znaks (Taurus, Virgo, Capricorn)</h3>
      ...
      <h3>💨 Zrak Znaks (Gemini, Libra, Aquarius)</h3>
      ...
      <h3>💧 Voda Znaks (Cancer, Scorpio, Pisces)</h3>
      ...
      <h2 id="love-planets">The Real Ljubav Planets: Venus, Mars & The Moon</h2>
      ...
      <h2 id="best-matches-deep-dive">Deep Dive: Famous Zodijak PZrakings</h2>
