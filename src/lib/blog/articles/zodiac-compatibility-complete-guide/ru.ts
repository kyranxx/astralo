...
export const ru: BlogPostTranslation = {
    title: "❤️ Зодиака Знак Compatibility: The Definitive Guide to Cosmic Любовь",
    ...
    content: `
      <h2 id="beyond-sun-signs">Why Солнце Знакs Aren't Everything</h2>
      ...
      <h2 id="elemental-love">The 4 Elements in Любовь</h2>
      ...
      <h3>🔥 Огонь Знакs (Овен, Лев, Стрелец)</h3>
      ...
      <h3>🌍 Земля Знакs (Телец, Девы, Козерог)</h3>
      ...
      <h3>💨 Воздух Знакs (Близнецы, Весы, Водолей)</h3>
      ...
      <h3>💧 Вода Знакs (Рак, Скорпион, Рыбы)</h3>
      ...
      <h2 id="love-planets">The Real Любовь Планетаs: Venus, Mars & The Луна</h2>
      ...
      <h3>1. The Луна 🌙 (Emotional Safety)</h3>
      ...
      <h3>2. Venus ♀ (Романтика & Values)</h3>
      ...
      <h2 id="best-matches-deep-dive">Deep Dive: Famous Зодиака PВоздухings</h2>
      
      <h3>The "Power Couple": Овен & Весы</h3>
      ...
      <h3>The "Empire Builders": Телец & Козерог</h3>
      ...
      <h3>The "Peter Pan" Duo: Близнецы & Стрелец</h3>
      ...
      <h3>The "Psychic Link": Рак & Скорпион</h3>
