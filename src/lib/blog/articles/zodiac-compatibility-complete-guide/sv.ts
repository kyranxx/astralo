...
export const sv: BlogPostTranslation = {
    title: "❤️ Zodiaken Tecken Compatibility: The Definitive Guide to Cosmic Kärlek",
    ...
    content: `
      <h2 id="beyond-sun-signs">Why Sol Teckens Aren't Everything</h2>
      ...
      <h2 id="elemental-love">The 4 Elements in Kärlek</h2>
      ...
      <h3>🔥 Eld Teckens (Väduren, Lejonet, Skytten)</h3>
      ...
      <h3>🌍 Jord Teckens (Oxen, Jungfrun, Stenbocken)</h3>
      ...
      <h3>💨 Luft Teckens (Tvillingarna, Vågen, Vattumannen)</h3>
      ...
      <h3>💧 Vatten Teckens (Kräftan, Skorpionen, Fiskarna)</h3>
      ...
      <h2 id="love-planets">The Real Kärlek Planets: Venus, Mars & The Måne</h2>
      ...
      <h3>1. The Måne 🌙 (Emotional Safety)</h3>
      ...
      <h2 id="best-matches-deep-dive">Deep Dive: Famous Zodiaken PLuftings</h2>
      
      <h3>The "Power Couple": Väduren & Vågen</h3>
      ...
      <h3>The "Empire Builders": Oxen & Stenbocken</h3>
      ...
      <h3>The "Peter Pan" Duo: Tvillingarna & Skytten</h3>
      ...
      <h3>The "Psychic Link": Kräftan & Skorpionen</h3>
