...
export const es: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="house-systems">Understanding Casa Systems: Placidus vs. Whole Signo</h2>
      ...
      <h2 id="planetary-placements">Major Planetas in the Casas: A Detailed Summary</h2>
      ...
      <h2 id="retrograde">Retrograde Planetas in the Casas</h2>
