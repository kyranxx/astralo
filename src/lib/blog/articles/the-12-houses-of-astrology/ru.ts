...
export const ru: BlogPostTranslation = {
    title: "🏠 The 12 Домs of Astrology: The Ultimate Guide to Your Life's Journey",
    ...
    content: `
      <h2 id="introduction">The Stage: Why Домs Matter</h2>
      ...
      <h2 id="house-systems">Understanding Дом Systems: Placidus vs. Whole Знак</h2>
      ...
      <h3>2. Succedent Домs (2, 5, 8, 11)</h3>
      ...
      <h2 id="the-first-house">1st Дом: The House of Self (Identity)</h2>
      ...
      <h2 id="the-second-house">2nd Дом: The House of Value (Wealth)</h2>
      ...
      <h2 id="the-third-house">3rd Дом: The House of Communication</h2>
      ...
      <h2 id="the-fourth-house">4th Дом: The House of Home (Roots)</h2>
      ...
      <h2 id="the-fifth-house">5th Дом: The House of Joy</h2>
      ...
      <h2 id="the-sixth-house">6th Дом: The House of Service</h2>
      ...
      <h2 id="the-seventh-house">7th Дом: The House of Partnership</h2>
      ...
      <h2 id="the-eighth-house">8th Дом: The House of Transformation</h2>
      ...
      <h2 id="the-ninth-house">9th Дом: The House of Wisdom</h2>
      ...
      <h2 id="the-tenth-house">10th Дом: The House of Purpose</h2>
      ...
      <h2 id="the-eleventh-house">11th Дом: The House of Community</h2>
      ...
      <h2 id="the-twelfth-house">12th Дом: The House of Unconscious</h2>
      ...
      <h2 id="planetary-placements">Major Планетаs in the Домs: A Detailed Summary</h2>
      ...
      <h2 id="stelliums">What is a Stellium in a Дом?</h2>
      ...
      <h2 id="empty-houses">What if a Дом is Empty? The Power of Rulers</h2>
      ...
      <h2 id="retrograde">Retrograde Планетаs in the Домs</h2>
      ...
      <h2 id="derived-houses">Advanced Technique: Derived Домs</h2>
      ...
      <h2 id="progressions">Progressed Домs: How Your Life Cycles Evolve</h2>
