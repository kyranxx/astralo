...
export const it: BlogPostTranslation = {
    ...
    content: `
      ...
      <h3>The Luna: The Minute Hand of Fate</h3>
      <p>While planets like Jupiter take a year to change signs, the <strong>Luna</strong> moves incredibly fast, zipping through a zodiac sign in just about 2.5 days. This makes the Moon the primary driver of your <em>daily</em> mood and emotional landscape. When the Moon is in fiery Aries, we feel impulsive and energetic. When it shifts into grounded Taurus, we collectively slow down and crave comfort.</p>

      <h3>The Aspects: Conversations Between Pianetas</h3>
      ...
      <h2 id="rising-vs-sun">The Golden Rule: Read for Your Ascendente Segno</h2>
      ...
      <h2 id="planetary-players">Key Pianetaary Players in Your Day</h2>
      ...
      <h2 id="zodiac-daily-styles">Daily Styles of the 12 Segnos</h2>
      
      <h3>♈ Ariete (March 21 - April 19)</h3>
      ...
      <h3>♍ Vergine (August 23 - September 22)</h3>
      ...
      <h3>♎ Bilancia (September 23 - October 22)</h3>
      ...
      <h3>♏ Scorpione (October 23 - November 21)</h3>
      ...
      <h3>♐ Sagittario (November 22 - December 21)</h3>
      ...
      <h3>♑ Capricorno (December 22 - January 19)</h3>
      ...
      <h3>♒ Acquario (January 20 - February 18)</h3>
      ...
      <h3>♓ Pesci (February 19 - March 20)</h3>
