...
export const sl: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="rising-vs-sun">The Golden Rule: Read for Your Rising Znamenje</h2>
      ...
      <h2 id="zodiac-daily-styles">Daily Styles of the 12 Znamenjes</h2>
