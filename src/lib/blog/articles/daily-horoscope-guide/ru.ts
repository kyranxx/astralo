...
export const ru: BlogPostTranslation = {
    ...
    content: `
      ...
      <h3>The Луна: The Minute Hand of Fate</h3>
      <p>While planets like Jupiter take a year to change signs, the <strong>Луна</strong> moves incredibly fast, zipping through a zodiac sign in just about 2.5 days. This makes the Moon the primary driver of your <em>daily</em> mood and emotional landscape. When the Moon is in fiery Aries, we feel impulsive and energetic. When it shifts into grounded Taurus, we collectively slow down and crave comfort.</p>

      <h3>The Aspects: Conversations Between Планетаs</h3>
      ...
      <h2 id="rising-vs-sun">The Golden Rule: Read for Your Асцендент Знак</h2>
      ...
      <h2 id="planetary-players">Key Планетаary Players in Your Day</h2>
      ...
      <h2 id="zodiac-daily-styles">Daily Styles of the 12 Знакs</h2>
      
      <h3>♈ Овен (March 21 - April 19)</h3>
      ...
      <h3>♍ Девы (August 23 - September 22)</h3>
      ...
      <h3>♎ Весы (September 23 - October 22)</h3>
      ...
      <h3>♏ Скорпион (October 23 - November 21)</h3>
      ...
      <h3>♐ Стрелец (November 22 - December 21)</h3>
      ...
      <h3>♑ Козерог (December 22 - January 19)</h3>
      ...
      <h3>♒ Водолей (January 20 - February 18)</h3>
      ...
      <h3>♓ Рыбы (February 19 - March 20)</h3>
