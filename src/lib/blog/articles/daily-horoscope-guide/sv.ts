...
export const sv: BlogPostTranslation = {
    ...
    content: `
      ...
      <h3>The Måne: The Minute Hand of Fate</h3>
      <p>While planets like Jupiter take a year to change signs, the <strong>Måne</strong> moves incredibly fast, zipping through a zodiac sign in just about 2.5 days. This makes the Moon the primary driver of your <em>daily</em> mood and emotional landscape. When the Moon is in fiery Aries, we feel impulsive and energetic. When it shifts into grounded Taurus, we collectively slow down and crave comfort.</p>
      ...
      <h2 id="rising-vs-sun">The Golden Rule: Read for Your Ascendent Tecken</h2>
      ...
      <h2 id="zodiac-daily-styles">Daily Styles of the 12 Teckens</h2>
      
      <h3>♈ Väduren (March 21 - April 19)</h3>
      ...
      <h3>♊ Tvillingarna (May 21 - June 20)</h3>
      ...
      <h3>♌ Lejonet (July 23 - August 22)</h3>
      ...
      <h3>♍ Jungfrun (August 23 - September 22)</h3>
      ...
      <h3>♎ Vågen (September 23 - October 22)</h3>
      ...
      <h3>♏ Skorpionen (October 23 - November 21)</h3>
      ...
      <h3>♐ Skytten (November 22 - December 21)</h3>
      ...
      <h3>♑ Stenbocken (December 22 - January 19)</h3>
      ...
      <h3>♒ Vattumannen (January 20 - February 18)</h3>
      ...
      <h3>♓ Fiskarna (February 19 - March 20)</h3>
