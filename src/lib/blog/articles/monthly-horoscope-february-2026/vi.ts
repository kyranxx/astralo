/**
 * monthly-horoscope-february-2026 - VI
 */
...
export const vi: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="fire-signs">🔥 Lửa Cungs (Aries, Leo, Sagittarius)</h2>
      ...
      <h2 id="earth-signs">🌍 Đất Cungs (Taurus, Virgo, Capricorn)</h2>
      ...
      <h2 id="air-signs">💨 Khí Cungs (Gemini, Libra, Aquarius)</h2>
      ...
      <h2 id="water-signs">💧 Nước Cungs (Cancer, Scorpio, Pisces)</h2>
