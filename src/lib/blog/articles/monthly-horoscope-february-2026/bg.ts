...
export const bg: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="fire-signs">🔥 Огън Знакs (Aries, Leo, Sagittarius)</h2>
      ...
      <h2 id="earth-signs">🌍 Земя Знакs (Taurus, Virgo, Capricorn)</h2>
      ...
      <h2 id="air-signs">💨 Въздух Знакs (Gemini, Libra, Aquarius)</h2>
