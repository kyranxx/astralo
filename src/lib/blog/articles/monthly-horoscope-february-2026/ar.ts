/**
 * monthly-horoscope-february-2026 - AR
 */
...
export const ar: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="fire-signs">🔥 نار برجs (Aries, Leo, Sagittarius)</h2>
      ...
      <h2 id="earth-signs">🌍 ارض برجs (Taurus, Virgo, Capricorn)</h2>
      ...
      <h2 id="air-signs">💨 هواء برجs (Gemini, Libra, Aquarius)</h2>
      ...
      <h2 id="water-signs">💧 ماء برجs (Cancer, Scorpio, Pisces)</h2>
