...
export const he: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="fire-signs">🔥 אש מזלs (Aries, Leo, Sagittarius)</h2>
      ...
      <h2 id="earth-signs">🌍 אדמה מזלs (Taurus, Virgo, Capricorn)</h2>
      ...
      <h2 id="air-signs">💨 אוויר מזלs (Gemini, Libra, Aquarius)</h2>
      ...
      <h2 id="water-signs">💧 מים מזלs (Cancer, Scorpio, Pisces)</h2>
