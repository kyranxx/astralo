/**
 * monthly-horoscope-february-2026 - FR
 */
...
export const fr: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="fire-signs">🔥 Feu Signes (Bélier, Lion, Sagittaire)</h2>
      ...
      <h2 id="earth-signs">🌍 Terre Signes (Taureau, Vierge, Capricorne)</h2>
      ...
      <h2 id="air-signs">💨 Air Signes (Gémeaux, Balance, Verseau)</h2>
      ...
      <h2 id="water-signs">💧 Eau Signes (Cancer, Scorpion, Poissons)</h2>
