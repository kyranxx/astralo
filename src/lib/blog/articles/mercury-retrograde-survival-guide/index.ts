...
export const mercuryRetrogradeSurvivalGuide: Record<string, BlogPostTranslation> = {
...
export function getTranslation(lang: string): BlogPostTranslation {
    return mercuryRetrogradeSurvivalGuide[lang] || mercuryRetrogradeSurvivalGuide.en;
}
