...
export const cs: BlogPostTranslation = {
    ...
    content: `
      ...
      <p>By the 5th Century BC, the Babylonians had developed the first concept of the <strong>Zvěrokruh</strong>, dividing the sun's path into twelve equal signs based on the constellations.</p>
