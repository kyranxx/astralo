...
export const id: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="saturn-in-signs">Saturn Return Through the Zodiak Tandas</h2>
      ...
      <h2 id="house-10">10th House: The Mountaintop of Karier</h2>
      ...
      <h2 id="post-return">Life After the Api: The 30s</h2>
