...
export const vi: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="saturn-in-signs">Saturn Return Through the Hoàng đạo Cungs</h2>
      ...
      <h2 id="house-10">10th House: The Mountaintop of Sự nghiệp</h2>
      ...
      <h2 id="post-return">Life After the Lửa: The 30s</h2>
