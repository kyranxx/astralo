...
export const sl: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="saturn-in-signs">Saturn Return Through the Zodiak Znamenjes</h2>
      ...
      <h2 id="house-10">10th House: The Mountaintop of Kariera</h2>
      ...
      <h2 id="post-return">Life After the Ogenj: The 30s</h2>
