...
export const ko: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="saturn-in-signs">Saturn Return Through the 황도대 별자리s</h2>
      ...
      <h2 id="house-10">10th House: The Mountaintop of 직업</h2>
      ...
      <h2 id="post-return">Life After the 불: The 30s</h2>
