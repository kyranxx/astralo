...
export const uk: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="saturn-in-signs">Saturn Return Through the Зодіак Знакs</h2>
      ...
      <h2 id="house-10">10th House: The Mountaintop of Кар'єра</h2>
      ...
      <h2 id="post-return">Life After the Вогонь: The 30s</h2>
