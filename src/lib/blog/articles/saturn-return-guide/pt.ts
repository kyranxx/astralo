...
export const pt: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="saturn-in-signs">Saturn Return Through the Zodíaco Signos</h2>
      ...
      <h2 id="house-10">10th Casa: The Mountaintop of Carreira</h2>
      ...
      <h2 id="post-return">Life After the Fogo: The 30s</h2>
