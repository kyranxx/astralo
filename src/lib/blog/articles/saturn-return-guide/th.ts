...
export const th: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="saturn-in-signs">Saturn Return Through the ราศี สัญลักษณ์s</h2>
      ...
      <h2 id="house-10">10th House: The Mountaintop of อาชีพ</h2>
      ...
      <h2 id="post-return">Life After the ไฟ: The 30s</h2>
