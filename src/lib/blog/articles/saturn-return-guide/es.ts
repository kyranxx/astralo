...
export const es: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="house-10">10th Casa: The Mountaintop of Carrera</h2>
      ...
      <h2 id="post-return">Life After the Fuego: The 30s</h2>
