...
export const ja: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="saturn-in-signs">Saturn Return Through the 干支 星座s</h2>
      ...
      <h2 id="house-10">10th House: The Mountaintop of キャリア</h2>
      ...
      <h2 id="post-return">Life After the 火: The 30s</h2>
