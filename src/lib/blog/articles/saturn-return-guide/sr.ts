...
export const sr: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="saturn-in-signs">Saturn Return Through the Зодијак Знакs</h2>
      ...
      <h2 id="house-10">10th House: The Mountaintop of Каријера</h2>
      ...
      <h2 id="post-return">Life After the Ватра: The 30s</h2>
