...
export const hi: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="saturn-in-signs">Saturn Return Through the राशि चक्र राशिs</h2>
      ...
      <h2 id="house-10">10th House: The Mountaintop of करियर</h2>
      ...
      <h2 id="post-return">Life After the अग्नि: The 30s</h2>
