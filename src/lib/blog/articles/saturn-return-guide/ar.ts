...
export const ar: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="saturn-in-signs">Saturn Return Through the الأبراج برجs</h2>
      ...
      <h2 id="house-10">10th House: The Mountaintop of المهنة</h2>
      ...
      <h2 id="post-return">Life After the نار: The 30s</h2>
