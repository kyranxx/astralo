/**
 * Monthly Horoscope January 2025 - English
 */
import type { BlogPostTranslation } from '../../types';

export const en: BlogPostTranslation = {
    title: '🌙 Monthly Horoscope January 2025: The Dawn of a New Era',
    excerpt: 'Complete January 2025 astrological forecast. Detailed monthly horoscope for Aries through Pisces, covering Pluto in Aquarius, love, career, and money trends.',
    category: 'Horoscopes',
    metaDescription: 'Complete January 2025 astrological forecast. Detailed monthly horoscope for Aries through Pisces, covering Pluto in Aquarius, love, career, and money trends.',
    keywords: 'monthly horoscope, january 2025 astrology, monthly predictions, zodiac forecast january, pluto in aquarius, new moon capricorn, full moon cancer',
    quickSummary: [
        'January 2025 is dominated by Pluto settling into Aquarius, signaling massive social shifts',
    ...
    content: `
      ...
      <h2 id="complete-horoscope">Get Your Complete 2025 Horoscope</h2>
      <p>This monthly overview is just the tip of the iceberg. Each person has a unique chart that interacts with these transits differently. To navigate 2025 with confidence, order your <strong>Personalized Year-Ahead Report</strong> from Astralo. It breaks down your specific transits month-by-month.
    `
};
