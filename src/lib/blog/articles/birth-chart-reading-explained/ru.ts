...
export const ru: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="the-big-three">The Big Three: Солнце, Луна, Асцендент</h2>
      ...
      <h3>3. The Ascendant / Асцендент Знак 🏹 (Mask)</h3>
      ...
      <h3>The Social & Outer Планетаs (Slow Moving)</h3>
      <ul>
      ...
      <h2 id="the-houses">The Stage: The 12 Домs</h2>
