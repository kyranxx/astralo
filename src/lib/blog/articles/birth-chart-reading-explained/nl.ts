/**
 * birth-chart-reading-explained - NL
 */
...
export const nl: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="the-big-three">The Big Three: Zon, Maan, Ascendant</h2>
      ...
      <h3>3. The Ascendant / Ascendant Sterrenbeeld 🏹 (Mask)</h3>
      ...
      <h3>The Social & Outer Planeets (Slow Moving)</h3>
      <ul>
      ...
      <h2 id="the-houses">The Stage: The 12 Huiss</h2>
