/**
 * birth-chart-reading-explained - SV
 */
...
export const sv: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="the-big-three">The Big Three: Sol, Måne, Ascendent</h2>
      ...
      <h3>3. The Ascendant / Ascendent Tecken 🏹 (Mask)</h3>
      ...
      <h2 id="the-houses">The Stage: The 12 Huss</h2>
