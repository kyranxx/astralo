/**
 * birth-chart-reading-explained - PT
 */
...
export const pt: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="the-big-three">The Big Three: Sol, Lua, Ascendente</h2>
      ...
      <h3>3. The Ascendant / Ascendente Signo 🏹 (Mask)</h3>
