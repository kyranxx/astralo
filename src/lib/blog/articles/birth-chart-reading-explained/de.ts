/**
 * birth-chart-reading-explained - DE
 */
...
export const de: BlogPostTranslation = {
    ...
    content: `
      ...
      <h2 id="the-big-three">The Big Three: Sonne, Mond, Aszendent</h2>
      ...
      <h3>3. The Ascendant / Aszendent Zeichen 🏹 (Mask)</h3>
      ...
      <h2 id="the-houses">The Stage: The 12 Hauss</h2>
